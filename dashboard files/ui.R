  ...
  windowTitle = "PA Housing Data Explorer",
        tabPanel("PA Mapper", 
         ...
         absolutePanel(id = "controls", class = "panel panel-default",
                       ...
                       selectInput("variable",                        
                                   ...
                                   choices = list("Homeowners" = list("Homeownership rate (2021)" = "owner_occ_hh_pct2021",
                                                                                                  "Median home value (2021)" = "med_home_value2021",
                                                                                                  "Mortgage burdened households (2021)" = "mortgage_burdened_pct2021"),
                                                                                "Renter households" = list("Rentership rate (2021)" = "renter_occ_hh_pct2021",
                                                                                                        "Rent burdened households (2021)" = "rent_burdened_pct2021",
                                                                                                        "Median gross rent (2021)" = "med_gross_rent2021"),
        ...
        tabPanel("County comparisons", 
          ...
          sidebarPanel2(width = 3,h3("Affordable Housing Explorer"), 
                       selectInput("variable_bar", "Select a variable",                                    choices = list("Homeowners" = list("Homeownership rate (2021)" = "owner_occ_hh_pct2021",
                                                                                                                                              "Median home value (2021)" = "med_home_value2021",
                                                                                                                                              "Mortgage burdened households (2021)" = "mortgage_burdened_pct2021"),
                                                                                                                          "Renter households" = list("Rentership rate (2021)" = "renter_occ_hh_pct2021",
                                                                                                                                                     "Rent burdened households (2021)" = "rent_burdened_pct2021",
        ...
        tabPanel("Data plotter", 
                 sidebarLayout(
                   sidebarPanel2(width = 3,h3("Affordable Housing Explorer"),
                                selectInput("variable_scatter_x", "X variable",                                    choices = list("Homeowners" = list("Homeownership rate (2021)" = "owner_occ_hh_pct2021",
                                                                                                                                                      "Median home value (2021)" = "med_home_value2021",
                                                                                                                                                      "Mortgage burdened households (2021)" = "mortgage_burdened_pct2021"),
                                                                                                                                  "Renter households" = list("Rentership rate (2021)" = "renter_occ_hh_pct2021",
                                                                                                                                                             "Rent burdened households (2021)" = "rent_burdened_pct2021",
        ...
        tabPanel("Data", 
                 sidebarLayout(
                   sidebarPanel2(width = 3, h3("Affordable Housing Explorer"), 
                                selectInput("variable_tab", "Select a variable",                                    choices = list("Homeowners" = list("Homeownership rate (2021)" = "owner_occ_hh_pct2021",
                                                                                                                                                       "Median home value (2021)" = "med_home_value2021",
                                                                                                                                                       "Mortgage burdened households (2021)" = "mortgage_burdened_pct2021"),
                                                                                                                                   "Renter households" = list("Rentership rate (2021)" = "renter_occ_hh_pct2021",
                                                                                                                                                              "Rent burdened households (2021)" = "rent_burdened_pct2021",
